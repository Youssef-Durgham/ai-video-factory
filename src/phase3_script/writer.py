...
⚠️ كل نقطة = حدث أو معلومة محددة (اسم شخص/مكان/ظاهرة + تاريخ/رقم + ما حصل بالضبط).
⚠️ لا تكتب نقاطاً عامة مثل "التوترات تصاعدت" أو "الأوضاع ساءت". اكتب أحداثاً ملموسة بتفاصيل دقيقة.
...
- مثال سيء: "في الغرف المغلقة، كان الدخان يتصاعد والقرارات تُصنع في ظل الظلام"
- مثال جيد: "في الثالث من مارس عام ألف وتسعمئة وأربعة وعشرين، ألغى مصطفى كمال أتاتورك نظام الخلافة العثمانية بقرار من البرلمان التركي في أنقرة"
{anti_repetition}
اكتب الآن."""
